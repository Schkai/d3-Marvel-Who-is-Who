...
In the following you can see an example of the hierarchical edge bundle, provided by [this page](https://bl.ocks.org/mbostock/7607999).
...
```
Quelle: https://bl.ocks.org/mbostock/7607999
